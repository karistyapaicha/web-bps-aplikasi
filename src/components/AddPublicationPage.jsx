      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500"
            placeholder="Contoh: Publikasi ini membahas Provinsi Kalimantan Selatan dalam Angka 2024 secara mendalam."
            rows={4}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-black-300 rounded-md bg-gray-100 text-gray-700 border border-gray-300 rounded-md shadow-sm file:bg-white file:border-0 file:px-4 file:py-2 file:rounded file:text-sm file:font-semibold"
          />
        </div>
